...
type VideoAsset = {
  ...
  status: JobStatus
  progress: number
  phase?: 'uploading' | 'compressing' | 'downloading'
  outputUri?: string
  outputSize?: number
  error?: string
}
...
type JourneyPhase = 'uploading' | 'compressing' | 'downloading'
...
function ConversionJourney({ phase, progress }: { phase: JourneyPhase; progress: number }) {
        ...
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          {!assets.length ? (
            ...
            <View key={asset.id} style={styles.card}>
              ...
              {(asset.status === 'converting' && asset.phase) && (
                <ConversionJourney phase={asset.phase} progress={asset.progress} />
              )}
